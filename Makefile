...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/11/14 10:02:04 by crfernan          #+#    #+#              #
#    Updated: 2018/11/18 21:30:51 by crfernan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES =	./ft_memset.c ./ft_bzero.c ./ft_memcpy.c ./ft_memccpy.c \
			...
			./ft_lstadd.c ./ft_lstiter.c ./ft_lstmap.c ./ft_count_if.c \
			./ft_print_tab.c ./ft_sqrt.c ./ft_sort_wordtab.c \
			./ft_words_str.c
OBJECTS =	ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
			...
			ft_count_if.o ft_print_tab.o ft_sqrt.o ft_sort_wordtab.o \
			ft_words_str.o
